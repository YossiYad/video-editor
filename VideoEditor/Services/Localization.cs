...
internal static class Localization
{
    private static readonly Dictionary<string, string> He = new(StringComparer.Ordinal)
    {
        ...
        ["Transcribe video"] = "תמלול הוידאו",
        ["Auto-generate subtitles with whisper.cpp"] = "יצירה אוטומטית של כתוביות עם whisper.cpp",
        ["Edit subtitles"] = "עריכת כתוביות",
        ["Edit subtitles…"] = "עריכת כתוביות…",
        ["Source"] = "מקור",
        ["Selected clip"] = "הקליפ הנבחר",
        ["All video clips"] = "כל קליפי הוידאו",
        ["Language"] = "שפה",
        ["Auto-detect"] = "זיהוי אוטומטי",
        ["Hebrew"] = "עברית",
        ["English"] = "אנגלית",
        ["Model"] = "מודל",
        ["Tiny — fastest (75 MB)"] = "Tiny — הכי מהיר (75 MB)",
        ["Base — balanced (140 MB)"] = "Base — מאוזן (140 MB)",
        ["Small — most accurate (470 MB)"] = "Small — הכי מדויק (470 MB)",
        ["Start"] = "התחל",
        ["Downloading whisper.cpp…"] = "מוריד את whisper.cpp…",
        ["Downloading model…"] = "מוריד מודל…",
        ["Extracting audio…"] = "מחלץ אודיו…",
        ["Transcribing…"] = "מתמלל…",
        ["Burning subtitles…"] = "צורב כתוביות…",
        ["Done"] = "סיים",
        ["Transcription failed"] = "התמלול נכשל",
        ["No video clip selected"] = "לא נבחר קליפ וידאו",
        ["Apply to project"] = "החל על הפרויקט",
        ["Discard transcription"] = "מחיקת התמלול",
        ["Start (s)"] = "התחלה (שניות)",
        ["End (s)"] = "סוף (שניות)",
        ["Text"] = "טקסט",
        ["Remove segment"] = "הסר קטע",
        ["Subtitles will burn into the export"] = "הכתוביות ייצרבו על הקובץ המיוצא",
    };
